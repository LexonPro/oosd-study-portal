import os
import json
import generate_sections_part1
import generate_sections_part2
import generate_sections_part3
import generate_sections_part4
import generate_sections_part5
import generate_sections_part6

part1 = generate_sections_part1.get_part1_sections()
part2 = generate_sections_part2.get_part2_sections()
part3 = generate_sections_part3.get_part3_sections()
part4 = generate_sections_part4.get_part4_sections()
part5 = generate_sections_part5.get_part5_sections()
part6 = generate_sections_part6.get_part6_sections()
  ...
  <header class="mobile-nav-header">
    ...
    <div class="mobile-controls">
      <div class="unit-switcher">
        ...
        <a href="index.html" class="unit-tab active" title="Current: Unit 2">U2</a>
    ...
    <aside id="sidebar" class="sidebar">
      <div class="sidebar-header">
        ...
        <div class="unit-switcher" style="margin: 12px 0 6px 0; width: 100%; justify-content: center; gap: 4px;">
          ...
          <a href="index.html" class="unit-tab active" style="flex: 1; justify-content: center; padding: 5px 2px; font-size: 11px;">
      ...
      <div class="top-nav-bar">
        ...
        <div class="action-tools">
          ...
          <div class="unit-switcher">
            ...
            <a href="index.html" class="unit-tab active">
...
print(f"index.html regenerated successfully! Size: {os.path.getsize('index.html')} bytes")
