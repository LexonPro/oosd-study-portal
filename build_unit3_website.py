# build_unit3_website.py: Assembles unit3.html from Parts 1, 2, and 3
import os
import json
import generate_unit3_part1
import generate_unit3_part2
import generate_unit3_part3

part1 = generate_unit3_part1.get_unit3_part1_sections()
part2 = generate_unit3_part2.get_unit3_part2_sections()
part3 = generate_unit3_part3.get_unit3_part3_sections()

all_sections = part1 + part2 + part3

print(f"Total Unit 3 sections assembled: {len(all_sections)}")
assert len(all_sections) == 28, f"Expected 28 sections, found {len(all_sections)}"

parts_meta = [
    {"num": 1, "title": "PART 1 — Object-Oriented Analysis & Design", "theme_class": "part-blue", "sections": part1},
    {"num": 2, "title": "PART 2 — SA/SD & Non-OO Implementation", "theme_class": "part-purple", "sections": part2},
    {"num": 3, "title": "PART 3 — OO Methodologies & Principles", "theme_class": "part-green", "sections": part3},
]
...
<body id="top" data-unit="unit3">
  ...
  <header class="mobile-nav-header">
    ...
    <div class="mobile-logo">
      <span class="accent-text">OOSD</span> Unit 3 (28 Topics)
    </div>
  ...
  <div class="app-layout">
    <!-- SLIDEBAR / SIDEBAR (All 28 Headings) -->
    <aside id="sidebar" class="sidebar">
      <div class="sidebar-header">
        <div class="logo-row">
          <div class="logo-mark" style="background: linear-gradient(135deg, #0284c7, #7c3aed);">U3</div>
          <div class="logo-text">
            <h3>OOSD Unit 3</h3>
            <span class="subtitle-tag">Complete Syllabus (28 Topics)</span>
          </div>
        </div>
        ...
        <div class="search-box">
          ...
          <input type="text" id="sidebar-search" placeholder="Search 28 topics (e.g. SA/SD, JSD, vtable)..." autocomplete="off">
          <button id="clear-search" class="clear-btn" title="Clear search" style="display: none;">✕</button>
        </div>

        <div class="sidebar-stats">
          <div class="stat-item">
            <span class="stat-val" id="current-sec-indicator">01 / 28</span>
          ...
          <div class="stat-item">
            <span class="stat-val" id="completed-count">0/28</span>
      ...
      <!-- Navigation Tree: All 28 Headings Grouped Under Parts -->
    ...
    <!-- MAIN SCROLLABLE CONTENT (1 to 28 Continuous Scroll) -->
    <main class="main-content">
      ...
      <div class="top-nav-bar">
        <div class="breadcrumbs">
          ...
          <span class="bc-unit">Unit 3 Master</span>
          <span class="bc-sep">/</span>
          <span class="bc-active" id="top-active-title">01. Object-Oriented Analysis (OOA)</span>
        </div>
      ...
      <header class="course-hero">
        ...
        <h2>Unit 3: Object-Oriented Analysis, Object Design, SA/SD, JSD & Non-OO Implementation</h2>
        <p class="hero-desc">
          An exhaustive, curriculum-aligned study guide covering all 28 topics in unrestricted continuous flow. Features real-life analogies, commented C/C++ code implementations, high-contrast vector architecture diagrams, deep comparison matrices, and AKTU university exam questions.
        </p>

        <div class="quick-stats-pills">
          <span class="q-pill">📚 3 Core Parts</span>
          <span class="q-pill">📌 28 Exhaustive Sections</span>
          <span class="q-pill">💡 Real-Life Analogies</span>
          <span class="q-pill">💻 Commented C/C++ Code</span>
          <span class="q-pill">📐 28 Vector SVGs</span>
      ...
      <footer class="app-footer">
        <div class="footer-content">
          <h4>OOSD Unit 3: Complete Study Master Portal</h4>
  ...
  <div id="floating-pill" class="floating-pill">
    ...
    <div class="float-center" id="float-label">
      ...
      <span class="f-text">Object-Oriented Analysis</span>
    </div>
...
with open("unit3.html", "w", encoding="utf-8") as f:
    f.write(html_template)

print(f"unit3.html generated successfully! File size: {os.path.getsize('unit3.html')} bytes")
